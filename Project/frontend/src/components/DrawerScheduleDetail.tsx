...
type DrawerScheduleDetailProp = {
  open: boolean;
  onClose: () => void;
};
const DrawerScheduleDetail = ({ open, onClose }: DrawerScheduleDetailProp) => {
  ...
  return (
    <>
      ...
      >
        <Box sx={{color: "white", }}>
          <Typography sx={{fontFamily: "Lato, sans-serif"}}>Detailed Schedule</Typography>
...
export default DrawerScheduleDetail;
